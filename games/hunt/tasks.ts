...
export const TASKS: readonly HuntTask[] = [
  ...
  { level: 9, kind: "sequence", title: "Descending cut", brief: "Walk High cut, Mid cut, Low cut. A wrong ledge resets the descent.", nodeLabels: ["High cut", "Mid cut", "Low cut"], timerMs: 45_000, failOnWrong: true, hint: "none", relic: false },
  ...
  { level: 11, kind: "dash", title: "Tide run", brief: "Leave the west buoy and reach the far reed across the bridges.", nodeLabels: ["Start buoy", "Far reed"], timerMs: 24_000, failOnWrong: false, hint: "none", relic: false },
  { level: 12, kind: "pick", title: "Live dish", brief: "Four dishes across the hexes. One is receiving. Warmth marks the beam.", nodeLabels: ["Port dish", "Solar dish", "Spare dish", "Aft dish"], timerMs: null, failOnWrong: false, hint: "hotcold", relic: false },
  { level: 13, kind: "job", title: "Broker's circuit", brief: "Take the Mask Broker's job, then walk Seed, Root, Bloom in order.", nodeLabels: ["Seed", "Root", "Bloom"], timerMs: 40_000, failOnWrong: true, hint: "none", relic: false },
